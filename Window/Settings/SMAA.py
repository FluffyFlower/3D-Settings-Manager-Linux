...
Date       : 23/01/2025
Version    : 1.0.1
Description: Contains classes representing various settings related to SMAA (Subpixel Morphological Anti-Aliasing), along with a base class for all graphics settings.
...
These settings specifically pertain to the VKBasalt post-processing tool's SMAA (Subpixel Morphological Anti-Aliasing) settings.
"""
...
class SMAA_Threshold(BaseSetting):
    ...
    def __init__(self):
        ...
        options = ("Select Option...", "Highest Quality", "Quality", "Balanced", "Low Quality", "Lowest Quality")
...
class SMAA_Search_Steps(BaseSetting):
    ...
    def __init__(self):
        ...
        options = ("Select Option...", "x32", "x16", "x8", "x4", "x2")
...
class SMAA_Search_Steps_Diagonal(BaseSetting):
    ...
    def __init__(self):
        ...
        options = ("Select Option...", "x16", "x8", "x4", "x2", "x0")
...
class SMAA_Corner_Rounding(BaseSetting):
    ...
    def __init__(self):
        ...
        options = ("Select Option...", "100", "75", "50", "25", "0")
        tooltip_header = f'<h3 {header}>Specifies how much sharp corners will be rounded</h3>'
        tooltip_body = f'<p {body_top}>Higher values round corners more.<br>Lower values round corners less (Adjust to your preference)</p><p {body_bot}>100 - Highest Rounding<br>75 - High Rounding<br>50 - Balanced Rounding<br>25 - Low Rounding<br>0 - Lowest Roundng</p>'
        rule = False
        super().__init__(title, options, tooltip_header, tooltip_body, rule)
