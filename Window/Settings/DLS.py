...
Version:
    0.1.1
Description:
    Contains classes representing various settings related to DLS (Denoised
    Luma Sharpening), along with a base class for all graphics settings.
    ...
    DLS (Denoised Luma Sharpening) settings.
"""
